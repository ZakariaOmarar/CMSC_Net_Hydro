"""Localization Head — multimodal 3-D source localizer for bench-top datasets.

Acoustic (GCC-PHAT / Transformer) and structural (accelerometer GCC-PHAT / 3-D CNN)
localization pipelines with FiLM-conditioned fusion for bench-top prototype datasets.
...
Public API — acoustic stream:
  ...
  srp_phat_3d, srp_phat_3d_hierarchical — SRP-PHAT grid search
...
def srp_phat_3d(
    ...
    *,
    ...
    Dataset-agnostic version; the S2 orchestrator's private ``_srp_phat_3d``
    is a special case with ``mic_pairs=MIC_PAIRS_S2``.
    ...
    Args:
        ...
        mic_pairs: List of (i, j) index pairs. Defaults to MIC_PAIRS_S2.
