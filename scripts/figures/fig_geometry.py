...
def fig03_geometry() -> None:
    ...
    fig.suptitle("Sensor arrays and the 16 labelled knock positions (prototype frame, m)",
                 fontsize=10)
...
def fig25_error_map() -> None:
    ...
    fig.suptitle(
        "Per-position held-out error: the failures lie on or outside the sensor hull",
        fontsize=10,
    )
